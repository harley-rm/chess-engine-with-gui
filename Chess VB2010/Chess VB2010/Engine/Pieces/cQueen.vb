...
Public Class cQueen
    ...
    Public Overrides Function calc_pseudo(BOARD As cBoard) As sMove()
        Dim possibleMoveOffsets As SByte() = {-8, -1, 1, 8, -9, -7, 7, 9}
    ...
    Private Function is_valid_tile(TARGET_COORDIANTE As Integer, OG_COORDINATE As Byte, OFFSET As Integer) As Boolean
        ...
        Select Case ogCol
            Case 1
                If OFFSET = -1 Or OFFSET = -9 Or OFFSET = 7 Then Return False
            Case 8
                If OFFSET = 1 Or OFFSET = -7 Or OFFSET = 9 Then Return False
        End Select
